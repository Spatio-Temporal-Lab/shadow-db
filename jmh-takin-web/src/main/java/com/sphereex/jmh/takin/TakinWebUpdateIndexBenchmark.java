...
public class TakinWebUpdateIndexBenchmark extends UnpooledIndexUpdateOnlyBenchmarkBase {
    @Override
    ...
    public void oltpUpdateOnly() throws Exception {
        String curl = "curl --location --request POST 'http://" + url + "/update_index' --header 'Content-Type: application/json'";
